...
type TmanageArrowOpacity = (gallery: HTMLDivElement | null, leftArrow: HTMLButtonElement | null, rightArrow: HTMLButtonElement | null)=> void
...
export const manageArrowOpacity: TmanageArrowOpacity = (gallery, leftArrow, rightArrow): void => {
