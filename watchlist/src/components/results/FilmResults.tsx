        ...
        <>
            {isFilmPosters ?
                <main className="flex-1 relative z-20 flex items-center justify-center mt-6 lg:pt-0 lg:mt-[2%]">
                    ...
                    <div id="gallery-results" className="gallery z-20 grid min-w-full h-full lg:pl-2 lg:min-w-[248px] lg:max-w-[66%] rounded-md overflow-x-scroll overflow-y-auto lg:overflow-y-hidden" data-gallery="results">
