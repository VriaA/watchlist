        ...
        <>
            {isFilmPosters ?
                <main className="flex-1 relative z-20 flex items-center justify-center mt-6 lg:pt-0 lg:mt-[2%]">
                    <button ref={leftArrowRef} onClick={scrollLeft} title="Scroll left" aria-label="Scroll left">
                        <svg className="hidden lg:inline-block cursor-pointer" aria-hidden={true} xmlns="http://www.w3.org/2000/svg" height="72px" viewBox="0 -960 960 960" width="72px" fill="#f8fafc">
                    ...
                    <button ref={rightArrowRef} onClick={scrollRight} title="Scroll left" aria-label="Scroll left">
                        <svg className="hidden lg:inline-block cursor-pointer" aria-hidden={true} xmlns="http://www.w3.org/2000/svg" height="72px" viewBox="0 -960 960 960" width="72px" fill="#f8fafc">
