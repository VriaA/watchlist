            ...
            <div className="w-[70%]">
                {hasVideos &&
                    <div className="flex justify-end items-center gap-3">
                        <button ref={leftArrowRef} onClick={scrollLeft} title="Scroll videos left" aria-label="Scroll videos left">
                        ...
                        <button ref={rightArrowRef} onClick={scrollRight} title="Scroll videos right" aria-label="Scroll vidoes right">
                            <svg className="hidden lg:inline-block cursor-pointer" aria-hidden={true} xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#f8fafc">
