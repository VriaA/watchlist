        ...
        <header className="flex justify-between items-center gap-2 w-full font-robotoCondensed mt-4 mb-[3svh] lg:mb-[4svh]">
            <nav className="flex flex-col gap-4">
                ...
                <ul className={`${!userWatchlist ? 'hidden' : ''} flex gap-2 text-sm md:text-base flex-wrap`}>
                    <li><Link to="." className={`watchlist-filter ${!filter ? 'bg-zinc-100 text-zinc-900 hover:bg-zinc-200' : ''}`}>All</Link></li>
                    <li><Link to="?filter=watched" className={`watchlist-filter ${filter === 'watched' ? 'bg-zinc-100 text-zinc-900 hover:bg-zinc-200' : ''}`}>Watched</Link></li>
                    <li><Link to="?filter=notwatched" className={`watchlist-filter ${filter === 'notwatched' ? 'bg-zinc-100 text-zinc-900 hover:bg-zinc-200' : ''}`}>Not watched</Link></li>
                </ul>
            </nav>
